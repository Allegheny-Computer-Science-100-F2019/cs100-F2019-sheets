...
software development programs such as a terminal window and a text editor. You
will continue to practice using Slack to support communication with the
teaching assistants and the course instructor. Next, you will learn more about
file input and output, further discovering how the course's automated grading
tool assesses your progress towards correctly completing the project. Finally,
you will continue to learn more about variables and data types and the ways in
which they are correctly combined.
...
determine if it correctly displays the story. As you are working on this
practical assignment, make sure that you can correctly answer these questions:
...
please see the instructor if you do not understand this policy.
