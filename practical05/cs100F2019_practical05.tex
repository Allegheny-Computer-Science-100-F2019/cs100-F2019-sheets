...
\program{content/sentence\_output.txt}. If you program does not produce this
file or the file does not have the correct contents, then make sure that you
talk with the course instructor or a student technical leader to identify any
mistakes in your source code.
