...
the meaning and purpose of each line.
...
\item Note that your program will alternate between printing and
  computing---this is okay! Specifically, the program's \program{main} method
...
\item A completed version of \mainprogramsource{} that both meets all of the
  established requirements and produces the desired output. In particular,
  please recall that this Java program should read a graphical image from the
  file system, perform three image transformations, save three images on the
  file system, and display the correct outputs in the terminal window, producing
  ten total lines of output.
