...
This course will have its second quiz on Monday, December 2, 2019 from 1:30 to
...
\begin{itemize}
  ...
  % Did not cover this in time for the quiz for the past two iterations of the
  % course

  % \item Chapter Eleven in Lewis \& Loftus, Sections 11.1--11.6 (i.e., ``Exceptions'')

  \item Using the basic commands in an operating system; editing in {\tt Atom},
    compiling and executing programs on your laptop; knowledge of the basic
...
the blank, short answer, true/false, and completion. The emphasis will be on
